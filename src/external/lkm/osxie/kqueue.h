#ifndef _OSXIE_LKM_KQUEUE_H_
#define _OSXIE_LKM_KQUEUE_H_
 ...
 *
 * Osxie's kqueues are implemented internally as regular Linux file descriptors that wait for XNU kqueues to wake up.
 *
