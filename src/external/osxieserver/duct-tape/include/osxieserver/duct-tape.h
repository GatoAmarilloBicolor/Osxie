#ifndef _OSXIESERVER_DUCT_TAPE_H_
#define _OSXIESERVER_DUCT_TAPE_H_
...
#include <osxieserver/duct-tape/types.h>
#include <osxieserver/duct-tape/hooks.h>
 ...
 *
 * This is used as the starting offset for thread IDs for kernelspace threads (which do not have a "real" managed Osxie thread backing them).
 */
...
#endif // _OSXIESERVER_DUCT_TAPE_H_
