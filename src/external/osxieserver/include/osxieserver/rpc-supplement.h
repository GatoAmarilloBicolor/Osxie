#ifndef _OSXIESERVER_RPC_SUPPLEMENT_H_
#define _OSXIESERVER_RPC_SUPPLEMENT_H_
 ...
 * that occur on the server side (in osxieserver). This is necessary
 ...
 *   3. our filter handler opens a kqchan using a osxieserver RPC call.
 *   4. osxieserver sets up the kqchan on the server side and sends back a socket
...
#endif // _OSXIESERVER_RPC_SUPPLEMENT_H_
