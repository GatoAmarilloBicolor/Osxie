#ifndef _OSXIESERVER_CONFIG_HPP_
#define _OSXIESERVER_CONFIG_HPP_
...
namespace DarlingServer {
	namespace Config {
		...
		constexpr std::string_view defaultMldrPath = LIBEXEC_PATH "/usr/libexec/osxie/mldr";
...
#endif // _OSXIESERVER_CONFIG_HPP_
