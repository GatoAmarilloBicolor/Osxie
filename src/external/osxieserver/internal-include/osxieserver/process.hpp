...
#ifndef _OSXIESERVER_PROCESS_HPP_
#define _OSXIESERVER_PROCESS_HPP_
...
namespace DarlingServer {
	...
	public:
		...
		/**
		 * The PID of this Process as seen from osxieserver's namespace.
		 */
		ID id() const;
...
#endif // _OSXIESERVER_PROCESS_HPP_
