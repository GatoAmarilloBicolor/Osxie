...
#ifndef _OSXIESERVER_THREAD_HPP_
#define _OSXIESERVER_THREAD_HPP_
...
#include <osxieserver/stack-pool.hpp>
...
namespace OsxieServer {
	...
	public:
		...
		/**
		 * The TID of this Thread as seen from osxieserver's namespace.
		 */
		ID id() const;
...
#endif // _OSXIESERVER_THREAD_HPP_
