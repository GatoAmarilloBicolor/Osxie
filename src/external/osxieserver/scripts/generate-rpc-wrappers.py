...
#       unfortunately, we can't expect everyone building Osxie to have Python 3.7+ installed.
calls = [
	#
	# FORMAT:
	...
	#       we only use our RPC for osxieserver calls.
	#
	...
	('mach_port_allocate', [
		...
		# but due to the way osxieserver handles Mach IPC calls,
...
license_header = """\
// This file has been auto-generated by generate-rpc-wrappers.py for use with osxieserver
...
public_header.write("""\
#ifndef _OSXIESERVER_API_H_
#define _OSXIESERVER_API_H_
