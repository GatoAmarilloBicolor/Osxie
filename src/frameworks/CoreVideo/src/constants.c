...
const CFStringRef kCVImageBufferYCbCrMatrix_SMPTE_240M_2006 = CFSTR("SMPTE_240M_2006");
...
const CFStringRef kCVImageBufferTransferFunction_SMPTE_ST_2086_HLG = CFSTR("SMPTE_ST_2086_HLG");
...
const CFStringRef kCVPixelBufferIOSurfaceCoreAnimationCompatibilityKey = CFSTR("IOSurfaceCoreAnimationCompatibility");
