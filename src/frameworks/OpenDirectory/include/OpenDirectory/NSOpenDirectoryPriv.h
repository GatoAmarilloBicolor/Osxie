...
#ifndef _OPENDIRECTORY_NSOPENDIRECTORYPRIV_H_
#define _OPENDIRECTORY_NSOPENDIRECTORYPRIV_H_

// in case someone includes this header without including the following header
#import <OpenDirectory/OpenDirectoryPriv.h>

#endif // _OPENDIRECTORY_NSOPENDIRECTORYPRIV_H_
