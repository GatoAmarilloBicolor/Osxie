...
void print_init()
{
	...
	std::cout << "_initializer:\n"
				"\tpushq   %rdi\n"
        		"\tmovq    L__osixie_elfcalls$non_lazy_ptr(%rip), %rax\n"
		        "\tmovq    (%rax), %rax\n"
	...
	std::cout << "_destructor:\n"
				"\tpushq   %rdi\n"
				"\tmovq    L__osixie_elfcalls$non_lazy_ptr(%rip), %rcx\n"
				"\tmovq    (%rcx), %rcx\n"
...
int main()
{
	...
	std::cout << ".section __IMPORT,__pointers,non_lazy_symbol_pointers\n"
				"L__osixie_elfcalls$non_lazy_ptr:\n"
		        ".indirect_symbol __osixie_elfcalls\n"
				".long   0\n\n";
