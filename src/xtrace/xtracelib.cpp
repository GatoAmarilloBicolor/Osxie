...
extern struct hook* _osxie_mach_syscall_entry;
extern struct hook* _osxie_mach_syscall_exit;
extern struct hook* _osxie_bsd_syscall_entry;
extern struct hook* _osxie_bsd_syscall_exit;
...
static void xtrace_setup_mach(void)
{
	uintptr_t area = (uintptr_t)_osxie_mach_syscall_entry;
	uintptr_t areaEnd = ((uintptr_t)_osxie_mach_syscall_exit) + sizeof(struct hook);
	...
	setup_hook(_osxie_mach_syscall_entry, (void*)osxie_mach_syscall_entry_trampoline, false);
	setup_hook(_osxie_mach_syscall_exit, (void*)osxie_mach_syscall_exit_trampoline, false);
...
static void xtrace_setup_bsd(void)
{
	uintptr_t area = (uintptr_t)_osxie_bsd_syscall_entry;
	uintptr_t areaEnd = ((uintptr_t)_osxie_bsd_syscall_exit) + sizeof(struct hook);
	...
	setup_hook(_osxie_bsd_syscall_entry, (void*)osxie_bsd_syscall_entry_trampoline, false);
	setup_hook(_osxie_bsd_syscall_exit, (void*)osxie_bsd_syscall_exit_trampoline, false);
